            ...
            {featuredPost && (
              <article className="featured-article">
                ...
                <h2 className="featured-article__title">
                  <Link href={`/healthherald/${featuredPost.slug}`}>
                    {featuredPost.title}
                  </Link>
                </h2>
                ...
                <Link href={`/healthherald/${featuredPost.slug}`} className="read-more-link">
                  Read Analysis
                </Link>
              </article>
            )}
              ...
              {secondaryPosts.map((post) => (
                <article key={post.slug} className="editorial-card">
                  ...
                  <h3 className="editorial-card__title">
                    <Link href={`/healthherald/${post.slug}`}>
                      {post.title}
                    </Link>
                  </h3>
                  <p className="editorial-card__excerpt">{post.excerpt}</p>
                  <Link href={`/healthherald/${post.slug}`} className="read-more-link">
                    Read Analysis
                  </Link>
                </article>
              ))}
